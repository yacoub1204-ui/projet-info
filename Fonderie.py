...
class Fonderie:
    ...
    def get_list_kg(self):
        '''liste des masses d'alliages disponibles'''
    ...
    def cout_alliage(self):
        '''calcule le cout par kilogramme total d'un alliage'''
        count = 0
        for pct, cout in zip(self.get_list_all().get_list_pct(), self.get_list_all().get_list_prix()):
            count += pct * cout
        return count
